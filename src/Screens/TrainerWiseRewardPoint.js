...
const TrainerWiseRewardPoint = () => {
    ...
    useEffect(() => {
        TrainerWiseRewardPointApi();
    }, []);

    const TrainerWiseRewardPointApi = async () => {
...
export default TrainerWiseRewardPoint
